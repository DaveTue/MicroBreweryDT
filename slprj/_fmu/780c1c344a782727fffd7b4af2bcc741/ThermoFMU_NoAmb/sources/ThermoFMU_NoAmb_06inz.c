...
#include "ThermoFMU_NoAmb_11mix.h"
#include "ThermoFMU_NoAmb_12jac.h"
#if defined(__cplusplus)
extern "C" {
#endif

void ThermoFMU_NoAmb_functionInitialEquations_0(DATA *data, threadData_t *threadData);
...
T = $START.T
*/
void ThermoFMU_NoAmb_eqFunction_2(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void ThermoFMU_NoAmb_eqFunction_4(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,4};
  (data->localData[0]->realVars[4] /* Vol_meters variable */) = (0.001) * ((data->simulationInfo->realParameter[4] /* Volume PARAM */));
  TRACE_POP
}
...
*/
void ThermoFMU_NoAmb_eqFunction_6(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
void ThermoFMU_NoAmb_functionInitialEquations_0(DATA *data, threadData_t *threadData)
{
  ...
  ThermoFMU_NoAmb_eqFunction_2(data, threadData);
  ...
  ThermoFMU_NoAmb_eqFunction_6(data, threadData);
  TRACE_POP
}

int ThermoFMU_NoAmb_functionInitialEquations(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH

  data->simulationInfo->discreteCall = 1;
  ThermoFMU_NoAmb_functionInitialEquations_0(data, threadData);
...
/* No ThermoFMU_NoAmb_functionInitialEquations_lambda0 function */

int ThermoFMU_NoAmb_functionRemovedInitialEquations(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
