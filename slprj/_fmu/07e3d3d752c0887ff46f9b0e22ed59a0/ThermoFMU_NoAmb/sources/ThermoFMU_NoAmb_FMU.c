...
#define MODEL_IDENTIFIER ThermoFMU_NoAmb
#define MODEL_GUID "{eac53829-e49e-4303-b0e9-931946015a64}"
...
#define FMI2_FUNCTION_PREFIX ThermoFMU_NoAmb_
...
extern void ThermoFMU_NoAmb_setupDataStruc(DATA *data, threadData_t *threadData);
#define fmu2_model_interface_setupDataStruc ThermoFMU_NoAmb_setupDataStruc
...
void setDefaultStartValues(ModelInstance *comp) {
  ...
  comp->fmuData->modelData->realParameterData[1].attribute.start = 1.2552;
  comp->fmuData->modelData->realParameterData[2].attribute.start = 0.0;
  comp->fmuData->modelData->realParameterData[3].attribute.start = 290.15;
  comp->fmuData->modelData->realParameterData[4].attribute.start = 25.0;
  comp->fmuData->modelData->realParameterData[5].attribute.start = 91200.0;
  comp->fmuData->modelData->realParameterData[6].attribute.start = 322.89;
}
// Set values for all variables that define a start value
OMC_DISABLE_OPT
void setStartValues(ModelInstance *comp) {
