...
set_param("suggarFerm", "StartTime", num2str(t_init));
set_param('suggarFerm','FixedStep', num2str(t_step));
set_param('suggarFerm','StopTime',num2str(t_stop))
